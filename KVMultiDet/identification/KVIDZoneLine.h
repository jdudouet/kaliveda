/*
$Id: KVIDZoneLine.h,v 1.2 2009/03/03 13:36:00 franklan Exp $
$Revision: 1.2 $
...
#ifndef __KVIDZONELINE_H
#define __KVIDZONELINE_H
...
/**
\class KVIDZoneLine
\brief Line in ID grid used to delimit regions with special flags
\ingroup Identification
*/

class KVIDZoneLine : public KVIDLine {
protected:
   KVString fAcceptedDirection;         //direction relative to Zone line corresponding to acceptable region
...
public:
   ...
   virtual Bool_t TestPoint(Double_t x, Double_t y)
   {
      ...
      // by this Zone line and the direction given to SetAcceptedDirection
   ...
   // This is redeclared to make it appear in context menus for KVIDZoneLines
   virtual void     SetName(const char* name)
   {
      KVIDLine::SetName(name);
   };  // *MENU*

   ClassDef(KVIDZoneLine, 1) //Line in ID grid used to delimit regions where identification is possible
};
