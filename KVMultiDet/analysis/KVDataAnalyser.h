...
specified by the task. See KVDataAnalysisTask.


#### Naming user files generated by analysis in batch mode
When running an analysis task using a batch system, the working directory where the
...
execution of the task begins. *Any* files generated by the user's analysis are copied back to the original directory at the end of
...
use the name of the batch job as a basis for naming such files:
